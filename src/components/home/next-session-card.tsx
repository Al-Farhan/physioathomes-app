  ...
  if (!session) {
    return (
      ...
      >
        ...
        <Text className="mt-1 text-body text-ink-secondary">
        ...
        >
          ...
          <Text className="text-body font-semibold text-surface">
            Book a session
          </Text>
        </Pressable>
      </View>
    ...
    >
      ...
      <View className="flex-row items-start justify-between gap-3">
        <View className="flex-1">
          <Text className="text-caption text-ink-secondary">Next session</Text>
          <Text className="mt-0.5 text-display font-semibold text-ink">
      ...
      <View className="mt-3 flex-row items-center gap-2">
        ...
        <Text
          className="flex-1 text-caption text-ink-secondary"
          numberOfLines={1}
        >
          {session.address}
        </Text>
      ...
      <View className="mt-5 flex-row gap-3">
        ...
        >
          <Text className="text-body font-medium text-ink">Reschedule</Text>
        </Pressable>
      </View>
    </View>
  );
